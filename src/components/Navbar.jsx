...
export default function Navbar() {
    return (
        <div className = "navBar fixed w-full bg-white/90 backdrop-blur-3xl flex md:flex-row justify-between items-center xsz:py-3 xsz:px-4 md:px-5 xl:px-9 2xl:px-14 2xl:py-5 xl:py-4 xsz:shadow-md xl:shadow-lg">
