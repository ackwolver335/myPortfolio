...
export default function Navbar() {
    return (
        <div className = "navBar sticky w-full flex md:flex-row justify-between items-center xsz:py-3 xsz:px-4 md:px-5 xl:px-9 2xl:px-14 2xl:py-5 xl:py-4 xsz:shadow-md xl:shadow-lg">
            ...
            <ul className = "flex md:flex-row font-poppins md:text-sm md:gap-4 2xl:gap-6 xl:text-base text-secondary">
                ...
                <li> <a href = "#" className = "hover:text-site ease-in duration-150 hover:text-shadow-black"> About </a> </li>
                <li> <a href = "#" className = "hover:text-site ease-in duration-150 hover:text-shadow-black"> Skills </a> </li>
