...
export default function About() {
    return (
        <div className="aboutComp md:py-16 lg:py-20 xl:py-24 flex flex-col md:gap-4" id="about">
            ...
            <div className="mainSection flex flex-row justify-between md:px-10 md:gap-10 lg:gap-20 xl:gap-24 lg:px-16 items-center">
                ...
                {/* Profile Image */}
                <img src={ProfilePic} alt="Profile Picture" className="md:w-2/6 lg:w-4/12 xl:w-3/12 md:rounded-full md:p-3 border-3 border-site border-t-transparent border-r-transparent md:shadow-lg shadow-site hover:scale-105 hover:shadow-xl cursor-pointer ease-in duration-150" />
                ...
                <div className="contentPara md:w-2/3 md:space-y-4 xl:space-y-7">
                    ...
                    <a href = "/Resume.pdf" target = "_blank" rel = "noopener noreferrer" className="resumeBlock flex flex-row justify-start md:gap-2 lg:gap-3 items-center">
                        ...
                        <h3 className = "md:text-sm lg:text-base xl:text-lg text-site font-inter hover:font-semibold ease-in duration-150"> Checkout Resume </h3>
